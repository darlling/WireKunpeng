...
from PySide2.QtGui import QCloseEvent, QFont, QIcon, QPixmap
...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self):
        ...
        self.packet_tree.setStyleSheet("background: white")
        ...
        self.pkt_detailWidget.setStyleSheet("background:white")
        ...
        self.hexBrowser.setStyleSheet("background:white")
        ...
        self.filterGoButton.setStyleSheet("background:white")
        ...
        self.choose_nicbox.setStyleSheet("background:white")
